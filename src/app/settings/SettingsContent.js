...
const InputField = ({ label, type = "text", placeholder, icon: Icon, defaultValue }) => (
  <div className="mb-4">
...
const SelectRow = ({ title, options, defaultValue }) => (
  <div className="flex items-center justify-between py-3">
    <h4 className="text-[15px] font-semibold text-gray-800">{title}</h4>
    <select 
      defaultValue={defaultValue}
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <SectionCard title="Edit Profile" description="Update your personal details and public profile.">
        <div className="flex items-center gap-5 mb-6">
          <div className="relative w-20 h-20 rounded-full bg-[#9a7ed9] overflow-hidden">
            <Image src="https://api.dicebear.com/7.x/notionists/svg?seed=FinPro&backgroundColor=9a7ed9" alt="Avatar" fill className="object-cover" />
          </div>
        ...
        <InputField label="Full Name" icon={User} defaultValue="Jane Doe" />
        <InputField label="Username" icon={User} defaultValue="@janedoe" />
      ...
      <SectionCard title="Contact Information" description="Manage your phone number and email address.">
        <InputField label="Phone Number" icon={Phone} type="tel" defaultValue="+62 812 3456 7890" />
        <InputField label="Email Address" icon={Mail} type="email" defaultValue="jane.doe@example.com" />
      </SectionCard>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 border border-gray-100 rounded-xl bg-gray-50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm">Mom</p>
                <p className="text-xs text-gray-500">+62 811 1111 111</p>
              </div>
            </div>
            <button className="text-xs text-red-500 font-semibold px-2 py-1 hover:bg-red-50 rounded">Remove</button>
          </div>
          <div className="flex items-center justify-between p-3 border border-gray-100 rounded-xl bg-gray-50">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold">D</div>
              <div>
                <p className="font-semibold text-gray-900 text-sm">Dad</p>
                <p className="text-xs text-gray-500">+62 822 2222 222</p>
              </div>
            </div>
            <button className="text-xs text-red-500 font-semibold px-2 py-1 hover:bg-red-50 rounded">Remove</button>
          </div>
          <button className="w-full flex items-center justify-center gap-2 py-3 border-2 border-dashed border-gray-200 rounded-xl text-gray-500 font-semibold hover:border-[#ee537f] hover:text-[#ee537f] transition-colors">
      ...
      <SectionCard title="SOS Settings">
        <SelectRow title="SOS Hold Duration" options={["3 Seconds", "5 Seconds", "10 Seconds"]} defaultValue="5 Seconds" />
        <div className="my-2 h-[1px] bg-gray-100" />
        <ToggleRow title="Auto Check-in Reminders" description="Remind me to check in during a Safe Commute." defaultChecked={true} />
        <div className="my-2 h-[1px] bg-gray-100" />
        <SelectRow title="Default Route Preference" options={["Safest", "Fastest", "Balanced"]} defaultValue="Safest" />
      </SectionCard>
    </div>
  );
}
...
export function NotificationSettings() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <SectionCard>
        <ToggleRow title="SOS Alerts" description="Receive critical alerts when a trusted contact triggers an SOS." defaultChecked={true} />
        <div className="my-2 h-[1px] bg-gray-100" />
        <ToggleRow title="Nearby Reports" description="Get notified about high-risk incidents reported near you." defaultChecked={true} />
        <div className="my-2 h-[1px] bg-gray-100" />
        <ToggleRow title="Safety Tips" description="Weekly community safety tips and app updates." defaultChecked={false} />
        <div className="my-2 h-[1px] bg-gray-100" />
        <ToggleRow title="Sharing Requests" description="Notify me when someone shares their live location with me." defaultChecked={true} />
      </SectionCard>
    </div>
  );
}
...
export function PreferencesSettings() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <SectionCard>
        <SelectRow title="Language" options={["English", "Indonesian"]} defaultValue="English" />
        <div className="my-2 h-[1px] bg-gray-100" />
        <SelectRow title="Distance Unit" options={["Kilometers (km)", "Miles (mi)"]} defaultValue="Kilometers (km)" />
        <div className="my-2 h-[1px] bg-gray-100" />
        <ToggleRow title="Dark Mode" description="Use a dark theme for the app interface." defaultChecked={false} />
      </SectionCard>
    </div>
  );
}
